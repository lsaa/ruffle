    ...
    public class Test extends Sprite {
        ...
        public function Test() {
            for each (var filterClass:Class in [GradientBevelFilter, GradientGlowFilter]) {
                ...
                // Ratios clamp: negatives used to wrap to 255 via ToUint32.
                ...
                // Quality -1 used to wrap to 15 via ToUint32.
                ...
                // Open bug: Flash gives 0 for huge strength, Ruffle saturates to 127.99.
